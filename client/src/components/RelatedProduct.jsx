...
const RelatedProduct = () => {
  return (
    <article className="w-60 max-md:w-54 max-sm:w-48 overflow-hidden h-76 cursor-pointer">
      <img
      ...
      />
      <h4 className="text-xl max-sm:text-[16px] max-md:text-[18px] font-semibold">
