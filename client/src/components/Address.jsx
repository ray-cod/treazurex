...
const Address = ({ address }) => {
  return (
    <article className="group relative p-6 bg-gray-900 hover:shadow-lg transition-all duration-300 rounded-xl min-h-70">
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2">
            <div
              className={`flex items-center text-xs rounded-2xl px-2 py-1 ${
                address.type === "Home"
            ...
            {address.isDefault && (
              <div className="inline-flex items-center text-xs border border-green-500 rounded-2xl px-2 py-1 text-green-500">
